...
@Composable
fun MetricsRow(likes: Int, views: Int, published: String) {
    Row(modifier = Modifier.fillMaxWidth()) {
        ...
        Icon(Icons.Default.Visibility, contentDescription = "views")
        Spacer(modifier = Modifier.width(4.dp))
        Text(views.toString(), style = MaterialTheme.typography.bodyMedium)
