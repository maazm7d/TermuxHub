...
fun ToolCard(
    ...
    onSave: (String) -> Unit // currently unused, consider removing if not needed
) {
    ...
    val favScale by animateFloatAsState(targetValue = if (isFav) 1.05f else 1f, label = "fav_scale")
